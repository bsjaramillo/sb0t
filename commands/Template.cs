...
namespace commands
{
    class Template
    {
        ...
        public static void Load(bool announce_loaded)
        {
            ...
            list.Add(new Item { Category = Category.EnableDisable, Index = 32, Text = "+n has enabled scribbles" });//71
            list.Add(new Item { Category = Category.EnableDisable, Index = 33, Text = "+n has disabled scribbles" });//72
            list.Add(new Item { Category = Category.EnableDisable, Index = 34, Text = "+n has enabled audios" });//71
            list.Add(new Item { Category = Category.EnableDisable, Index = 35, Text = "+n has disabled audios" });//72
            list.Add(new Item { Category = Category.EnableDisable, Index = 36, Text = "+n has enabled buzzes" });//71
            list.Add(new Item { Category = Category.EnableDisable, Index = 37, Text = "+n has disabled buzzes" });//72
